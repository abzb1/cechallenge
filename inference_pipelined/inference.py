...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt-path",
                        type=str,
                        default="/home1/ohs/cechallenge/ckpt/pipelined/",
    ...
    # if local_rank == 0:
    #     llama_model = get_stage.model_0()
    
    # elif local_rank == 1:
    #     llama_model = get_stage.model_1()

    # elif local_rank == 2:
    #     llama_model = get_stage.model_2()

    # if local_rank == 3:
    #     llama_model = get_stage.model_3()
