...
if __name__ == "__main__":
    ...
    torch.distributed.init_process_group("nccl", world_size=8, rank=local_rank)
    ...
    parser.add_argument("--ckpt-path",
                        type=str,
                        default="/home1/ohs/ongoing_proj/xtwice/cechallenge/v2_70b/inference_pipelined/pp_model/",
    ...
    recv_buff = torch.empty((4, 1024, 8192)).to("cuda")
    ...
    for i, concat in enumerate(tqdm(concat_lst)):
        ...
        if local_rank == 0:
        ...
        elif local_rank in [1,2,3,4,5,6]:
            ...
            # if i %100 == 0:
            #     now_dt = dt.datetime.now()
            #     print("at", local_rank, "processed", i+1," examples", now_dt.strftime("%H시 %M분 %S초"))
